...
- `-ResourceGroupName` (Opcional): Nombre del resource group (default: rg-cjf-alz-deployment)
...
- `-g, --resource-group` (Opcional): Nombre del resource group (default: rg-cjf-alz-deployment)
