# PowerShell Script for ALZ Deployment - CJF
...
param(
    ...
    [Parameter(Mandatory=$false)]
    [string]$ResourceGroupName = "rg-cjf-alz-deployment",
...
if (-not $rg) {
    ...
    az group create `
        ...
        --tags Environment=Production Project="CJF-ALZ" ManagedBy="PowerShell" DeploymentDate=(Get-Date -Format "yyyy-MM-dd") | Out-Null
