...
1. **Management Groups Hierarchy**
   ...
   - Capturar: Vista completa de la jerarquía de Management Groups (cjf, cjf-platform, cjf-landingzones, etc.)
...
3. **User Assigned Managed Identity**
   - Ubicación: Azure Portal → Resource Groups → CJF-mgmt → Managed Identities
...
30. **Defender for Cloud - Email Contact Configuration**
    ...
    - Capturar: Configuración de email contact: administrador@CJFGJ.onmicrosoft.com
